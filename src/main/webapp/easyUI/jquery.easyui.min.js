...
if(opts.onSubClick){//kxd 分隔按钮子按键点击事件
opts.onSubClick.call(this,btn);
} 
if(!_42c()){
_42d(_42a);
return false;
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"该输入项为必输项",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_444,blur:_448,mouseenter:_44c,mouseleave:_44f,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
$(_4b8).addClass("filebox-f").textbox($.extend({},opts,{onClickButton:function(){
	_4b9.filebox.find(".textbox-value").click();
	opts.onClickButton.call(_4b8);
	}}));
...
file.attr("id",id).attr("name",$(_4b8).attr("textboxName")||"").change(function(){
$(_4b8).filebox("setText",this.files[0].name);//this.value
...
//add kxd
clearTimeout(opts.clickTimeCell);
opts.clickTimeCell = setTimeout(function(){
...
clearTimeout(opts.clickTime);
opts.clickTime = setTimeout(function(){
...
//kxd
function getEditRows(_65e){
var _65f=$.data(_65e,"datagrid");
var opts=_65f.options;
var data=_65f.data;
var rows=[];
opts.finder.getTr(_65e,"","editing",2).each(function(){
	rows.push(opts.finder.getRow(_65e,$(this)));
});
return rows;
};
...
function _5f8(_683,_684,_685,isOff){
...
tr.attr("id",_782.rowIdPrefix+"-"+_785+"-"+(i-1));
    //var tr1 = opts.finder.getTr(_780, i, "body", 1).attr("datagrid-row-index", i - 1).attr("id",_782.rowIdPrefix+"-1-"+(i-1));
...
//break;
case 13:
	if(opts.keyHandler.isExist){
		if(!opts.keyHandler.isExist.call(_920,q,e)){
			return false;
		}
	}
e.preventDefault();
...
//kxd add combobox失去焦点时判断值是否存在，不存在时清空
function _91k(e){
	var _91k=e.data.target;
	var t=$(_91k);
	var _921=t.data("combo");
	var opts=t.combo("options");
	var q=t.combo("getText");
    if(opts.offset == true) return;
	if(opts.keyHandler.isExist){
		if(!opts.keyHandler.isExist.call(_91k,q,e)){
			t.combobox("select","");
		}else{
			var _975=$.data(_91k,"combobox");
			var data=_975.data;
			...
			$.map(qq,function(q){
				...
				for(var i=0;i<data.length;i++){
					var row=data[i];
					if(opts.queryValue.call(_91k,q,row)){
						t.combobox("select",row.COMBO_KEY);
					}
				}
			});
...
//kxd add combobox回车时判断值是否存在，不存在时清空
function _92k(e){
...
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_91b,keyup:_91f,paste:_91f,drop:_91f,blur:_91k},panelWidth:null,panelHeight:200,panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:null,panelAlign:"left",multiple:false,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
},query:function(q,e){
},isExist:function(q,e){ //kxd add
}},onShowPanel:function(){
},onHidePanel:function(){
},onChange:function(_94c,_94d){ //kxd add
}});
})(jQuery);
(function($){
var _94e=0;
...
//kxd add 
function _97k(_974,q){
	var _975=$.data(_974,"combobox");
	var opts=_975.options;
	var qq=opts.multiple?q.split(opts.separator):[q];
	var data=_975.data;
	var vv=[];
	if(($.map(qq,function(q){
		q=$.trim(q);
		var _978=q;
		var _979=undefined;
		for(var i=0;i<data.length;i++){
			var row=data[i];
			if(opts.queryValue.call(_974,q,row)){
				return true;
			}
		}return false;
	}))[0]){return true}
...
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupField:null,
	panelHeight:'auto',		// 下拉框自动匹配高度
	panelMaxHeight:230,		// 下拉框最大高度
...
return row[opts.textField].indexOf(q)>-1;//kxd add 将从头位置匹配改为任意匹配    
},queryValue:function(q,row){ //kxd add
var opts=$(this).combobox("options");
if(opts.speVal){
	return opts.speVal(q,row);
}
return $.trim(row[opts.textField].toLowerCase())==q.toLowerCase();
...
$(this).closest("div.combo-panel").panel("close");
	...
	$(this).closest("div.combo-panel").panel("close")}}],formatter:function(date){
...
// 默认控件不显示秒数
$.fn.datetimebox.defaults=$.extend({},$.fn.datebox.defaults,{spinnerWidth:"100%",showSeconds:false,timeSeparator:":",keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
