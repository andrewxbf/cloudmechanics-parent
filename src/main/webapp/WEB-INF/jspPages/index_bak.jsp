    ...
    <div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'north'" class="_layout_north overflow-hidden bor-btm" style="height:65px;">
            ...
            <%--<div class="new-top clearfix">
                <div class="fleft top-left clearfix" style="width: 160px;"></div>
                <ul class="fleft top-center clearfix" style="margin-left: 170px;">
                    <li id="menu123">
                        <a href="javascript:void(0)" class="showCenter" name="adsd">
                            <i class="icon-bg"></i>123</a>
                    </li>
                </ul>
            </div>--%>
        </div>
        ...
        <div data-options="region:'west'" class="_layout_west nav-group"
            ...
            <ul class="nav nav-pills nav-stacked" id="nav-1">
                <li>
                    ...
                    <dl class="dls">
                        <dd>
                            <a id="000" class="_sub_menu" url="">&nbsp;&nbsp; 升级包配置</a>
                        </dd>
                        <dd>
                            <a id="aaa" class="_sub_menu" url="auto/showJenkinsServerConfig.do">&nbsp;&nbsp; Jenkins配置</a>
                        </dd>
                        <dd>
                            <a id="bbb" class="_sub_menu" url="downloadServer.jsp">&nbsp;&nbsp; 下载服务器配置</a>
                        </dd>
                        <dd>
                            <a id="ccc" class="_sub_menu" url="uploadServer.jsp">&nbsp;&nbsp; 上传服务器配置</a>
                        </dd>
                    </dl>
                </li>
            </ul>
