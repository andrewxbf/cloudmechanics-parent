            ...
            <div data-options="region:'west',noheader:true,border:false" class="_sub_west"
                ...
                <table id="_grid" data-options="fitColumns:true">
                    ...
                    <tr>
                        ...
                        <th data-options="field:'jksHostIp',sortable:true,width:'200',halign:'center',align:'center'"
                            editor="{type:'validatebox',options:{required:true,validType:'length[0,15]'}}">IP地址
                        </th>
                        <th data-options="field:'jksPort',sortable:true,width:'200',halign:'center',align:'center'"
                            editor="{type:'numberbox',options:{required:true,min:0,max:65535}}">端口
                        </th>
                        <th data-options="field:'jksUserName',sortable:true,width:'200',halign:'center',align:'center'"
                            editor="{type:'validatebox',options:{validType:'length[0,32]'}}">用户名
                        </th>
                        <th data-options="field:'jksPassword',sortable:true,width:'200',halign:'center',align:'center'"
...
<script type="text/javascript">
    ...
    $.parser.onComplete = function (context) {
        ...
        common.createDataGrid("_grid", "jenkins/getJenkinsServerConfigList.do", "_gridmenu", null, gridParam, false);
        ...
        $("#_save").click(
            function () {
                ...
                ajaxUtil.post("jenkins/saveJenkinsServerConfig.do",
                    {
                        jenkinsVO: JSON.stringify(rowsData)
                    },
                    false,
                    function (data) {
                        if (data.status == 1) {
